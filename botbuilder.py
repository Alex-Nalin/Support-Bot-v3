...
class SymSession:
    ...
    def Authenticate(self):
        ...
        if self.SessionToken != '':
            ...
            #botlog.LogSymphonyInfo("sessionToken: " + self.SessionToken)
            ...
            if self.KeyAuthToken != '':
                ...
                #botlog.LogSymphonyInfo("keyManagerToken: " + self.KeyAuthToken)
    ...
    def LimitedAuth(self):
        ...
        for index in range(0, 5):
            ...
            if self.IsAuthenticated:
                ...
                botlog.LogSymphonyError('Authentication attempt ' + str(index) + 'failed. Trying again in 5 seconds.')
                time.sleep(5)
    ...
    def LimitedDatafeedConnect(self):
        ...
        for index in range(0, 5):
            ...
            if self.IsDatafeedConnected:
                ...
                botlog.LogSymphonyError('Datafeed Connect attempt ' + str(index) + 'failed. Trying again in 5 seconds.')
                time.sleep(5)
