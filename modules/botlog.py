...
_errlog = logging.getLogger('supportBot.error')

_symlog = logging.getLogger('supportBot.symphony')
_symErrorLog = logging.getLogger('supportBot.symphony.error')

_pluginLog = logging.getLogger('supportBot.plugins')
_pluginErrorLog = logging.getLogger('supportBot.plugins.error')
